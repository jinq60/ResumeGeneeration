<template>
  <div class="min-h-screen bg-surface-container-lowest">
    <!-- Top Navbar -->
    <header class="sticky top-0 z-50 h-16 flex items-center bg-surface-container-lowest border-b border-outline-variant shadow-sm">
      <div class="max-w-[1440px] mx-auto px-margin-page w-full flex items-center justify-between">
        <div class="flex items-center gap-8">
          <div class="text-title-lg font-title-lg text-primary flex items-center gap-2">
            <el-icon size="28">
              <Document />
            </el-icon>
            智能简历
          </div>
          <nav class="hidden md:flex items-center gap-6 text-label-md font-label-md">
            <a
        ...
        <div class="flex items-center gap-3">
          <button
            class="text-on-surface-variant hover:text-primary px-4 py-2 rounded-lg font-label-md transition-colors"
            @click="goTo('/login')"
          >
            登录
          </button>
    ...
    <!-- Footer -->
    <footer class="bg-on-surface text-surface-variant py-12 px-margin-page">
      <div class="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <div class="text-title-lg font-title-lg text-white flex items-center gap-2 mb-4">
            <el-icon size="24">
              <Document />
            </el-icon>
            智能简历
          </div>
          <p class="text-body-md font-body-md text-surface-variant/80">
            AI 驱动的职场晋升利器
          </p>
        </div>
        <div>
          <h4 class="text-title-md font-title-md text-white mb-4">
            产品
          </h4>
          <ul class="space-y-2 text-body-md font-body-md text-surface-variant/80">
            <li>
              <a
                href="#"
...
import {
  Document, MagicStick, ArrowRight, VideoPlay, CircleCheckFilled,
