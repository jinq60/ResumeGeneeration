...
const reviewForm = ref({ jobDescription: (route.query.jd as string) ? decodeURIComponent(route.query.jd as string) : '' })
...
async function handleAnalyze() {
  ...
  try {
    ...
    const response = await resumeApi.review(resumeId, { jobDescription: reviewForm.value.jobDescription })
    reviewResult.value = response as ReviewResult
