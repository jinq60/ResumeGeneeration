<template>
  <div class="user-management">
    ...
    <div class="search-bar">
      ...
      <el-select v-model="typeFilter" placeholder="用户类型" clearable style="width: 150px; margin-left: 10px">
        <el-option label="全部" value="" />
    ...
    <div class="user-list">
      <el-table :data="userList" v-loading="loading">
        ...
        <el-table-column label="用户类型" width="100">
          <template #default="{ row }">
            <el-tag :type="row.isGuest ? 'info' : 'primary'" size="small">
              {{ row.isGuest ? '游客' : '注册用户' }}
            </el-tag>
          </template>
        </el-table-column>
        ...
        <el-table-column prop="resumeCount" label="简历数" width="80" />
    ...
    <el-dialog v-model="detailDialogVisible" title="用户详情" width="600px">
      <div v-if="currentUser" class="user-detail">
        ...
        <el-descriptions :column="2" border>
          ...
          <el-descriptions-item label="简历数量">{{ currentUser.resumeCount }}</el-descriptions-item>
